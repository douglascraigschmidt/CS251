 ...
 * @class Platform
 *
 * @brief Each platform (e.g., Android, command-line, etc.) subclasses
 *        from this Singleton, which allows a client to send and
 *        retrieve data from the expression tree processing app in a
